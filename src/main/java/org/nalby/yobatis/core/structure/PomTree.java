...
import org.nalby.yobatis.core.exception.InvalidPomException;
import org.nalby.yobatis.core.exception.UnsupportedProjectException;
...
import org.nalby.yobatis.core.xml.PomXmlParser;
...
public class PomTree {
	...
	/**
	 * Get database connector's jar path based on the {@code driverClassName}, the
	 * first <dependency> will be used if multiple found.
	 * 
	 * @param driverClassName
	 *            the database's driver class name.
