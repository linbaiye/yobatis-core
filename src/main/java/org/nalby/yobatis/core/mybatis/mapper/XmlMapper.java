...
public class XmlMapper extends GeneratedXmlFile implements YobatisUnit {
    ...
    private XmlMapper(Document document, String pathToPut, IntrospectedTable table) {
    ...
    public static XmlMapper wrap(Document document, IntrospectedTable table) {
        ...
        return new XmlMapper(document, path, table);
    }
}
