...
public class LegacyMapperXmlElementFactoryImpl implements LegacyMapperXmlFactory {
    ...
    private final static LegacyMapperXmlElementFactoryImpl instance = new LegacyMapperXmlElementFactoryImpl();

    private LegacyMapperXmlElementFactoryImpl() { }

    public static LegacyMapperXmlElementFactoryImpl getInstance() {
        return instance;
    }
