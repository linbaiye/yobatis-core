...
//It's copied from spring-framework project.
...
public class AntPathMatcher {
	...
	private final Map<String, String[]> tokenizedPatternCache = new HashMap<String, String[]>(256);

	final Map<String, AntPathStringMatcher> stringMatcherCache = new HashMap<String, AntPathStringMatcher>(256);
	...
	public AntPathMatcher(String pathSeparator) {
		Expect.notNull(pathSeparator, "'pathSeparator' is required");
	...
	public String combine(String pattern1, String pattern2) {
		if (TextUtil.isEmpty(pattern1) && TextUtil.isEmpty(pattern2)) {
			return "";
		}
		if (TextUtil.isEmpty(pattern1)) {
			return pattern2;
		}
		if (TextUtil.isEmpty(pattern2)) {
			return pattern1;
		}
